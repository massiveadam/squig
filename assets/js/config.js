...
const targets = [
    { type:"Custom",  files:["Massive HRTF V6 Target", "Meg HRTF", "Austen V1 HRTF"] },
...
const  preference_bounds_name = "Bounds",  // Preference bounds name
       ...
       tiltableTargets = ["ARI, HUTUBS, RIEC, SONICOM AVG","ISO 11904","Meg HRTF", "Massive HRTF V6 Target", "Austen V1 HRTF"],                 // Targets that are allowed to be tilted
       compTargets = ["ARI, HUTUBS, RIEC, SONICOM AVG","ISO 11904","Meg HRTF", "Massive HRTF V6 Target", "Austen V1 HRTF"],                     // Targets that are allowed to be used for compensation
